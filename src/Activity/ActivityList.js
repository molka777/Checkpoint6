...
const ActivityList = () => {
    const [activities, setActivities] = useState([{ id: 1, imgUrl: camping, title: 'Camping', paragraph: 'Nous avons tout le nécessaire pour vous emmener camper dans les coins les plus sauvages et mystérieux...Vous pouvez apporter votre propre matériel si vous êtes déjà un adepte du camping !', time: 'Nombre de nuitées', rate: 5 },
