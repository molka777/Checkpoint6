        ...
        <Navbar className=" bg-light" style={{ zIndex: '1000' }} expand="lg">
            ...
            <Navbar.Collapse style={{ marginLeft: '4%', marginTop: '2.5%' }} id="basic-navbar-nav">
                <Nav className="mr-auto" style={{ letterSpacing: '1px' }}>
                    ...
                    <Link to="/event" style={{ color: '#093219', fontWeight: '600', width: '110px' }}>Évènements</Link>
                    <Link to="/sortie" style={{ color: '#093219', fontWeight: '600', width: '132px' }}>Sorties privées</Link>
