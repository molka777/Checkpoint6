...
const Sortie = () => {
  ...
  return (
    <>
      <Menu4 />
      <h1 id="about" className="title" style={{ margin: "1%" }}>
        LES SORTIES PRIVÉES
      </h1>
      <div>
      ...
      <div className="container">
        <div
          className="jumbotron p-4 p-md-5 text-white rounded bg-green"
          style={{
            width: "121%",
            marginLeft: "-11%",
          }}
        >
          <div className="px-0">
            ...
            <p className="lead my-3">
              Créez votre propre sortie, faite sur mesure en fonction des
              besoins et des envies de votre groupe.{" "}
            </p>
          </div>
          <Accordion defaultActiveKey="0">
            <Card style={{ border: "0px solid rgb(0 0 0 / 0%)" }}>
              ...
              <Accordion.Collapse eventKey="1">
                <Card.Body
                  style={{ backgroundColor: "#002b11", color: "white" }}
                >
                  Selon s’il s’agit de retrouvailles familiales, d’une escapade
                  en couple, entre amis ou même seul, vos choix diffèreront et
                  orienteront l’aventure vers des rêves aux couleurs et aux
      ...
      >
        ...
        >
          Consultez nos offres de sorties privées
        </p>
      </button>
      ...
      <div
        className="title3"
        style={{ textTransform: "unset", fontSize: "x-large" }}
      >
        2. Remplir le formulaire ci-dessous
      </div>
      <iframe
        style={{ marginTop: "6%", marginLeft: "13%" }}
        src="https://docs.google.com/forms/d/e/1FAIpQLScFrN6ElddtmTa_-Ae1nuf-M_3M1hkOLR_YDvkxn32Vbu0_ww/viewform?embedded=true"
        width="1000"
        height="520"
        frameborder="0"
        marginheight="0"
      ...
      >
        <Carousel.Item>
          <img className="d-block w-100" src={moment1} alt="First slide" />
        </Carousel.Item>
        <Carousel.Item>
          <img className="d-block w-100" src={moment2} alt="Third slide" />
        </Carousel.Item>
        <Carousel.Item>
          <img className="d-block w-100" src={moment3} alt="Third slide" />
        </Carousel.Item>
        <Carousel.Item>
          <img className="d-block w-100" src={moment4} alt="Third slide" />
        </Carousel.Item>
        <Carousel.Item>
          <img className="d-block w-100" src={moment5} alt="Third slide" />
        </Carousel.Item>
        <Carousel.Item>
          <img className="d-block w-100" src={moment6} alt="Third slide" />
        </Carousel.Item>{" "}
        <Carousel.Item>
          <img className="d-block w-100" src={moment7} alt="Third slide" />
        </Carousel.Item>
      </Carousel>{" "}
    </>
  );
